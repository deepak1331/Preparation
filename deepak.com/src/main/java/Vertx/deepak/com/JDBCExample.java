...
public class JDBCExample extends AbstractVerticle {
  ...
  public void start() throws Exception {
    ...
    final JDBCClient client = JDBCClient.createShared(vertx, new JsonObject()
        .put("url", "jdbc:redshift://jrg-redshift-prod.ctynw6vfk96h.us-east-1.redshift.amazonaws.com:5439/lucktastic")
        .put("driver_class", "com.amazon.redshift.jdbc42.Driver")
        .put("max_pool_size", 30)
        .put("user", "google_sheets_automation")
        .put("password", "Ab534320454"));
